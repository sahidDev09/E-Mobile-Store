...
const Discount = () => {
  return (
    <div>
      <div className=" grid sm:grid-cols-2 justify-between items-center container mx-auto sm:mt-10 md:mt-10 lg:mt-0 p-10 sm:p-0">
      <div>
        <h1 className=" text-5xl font-bold text-red-400 uppercase">
          EID discount 50%
        </h1>
        <p className=" text-gray-500">
          catch your discount cupon before deadlinen 23/7/2023
        </p>
      ...
      <div>
        <lottie-player
          ...
          loop
          mode="normal"
          src="https://lottie.host/2dfa3c8a-2c9a-48b6-aa00-22d1f18281f5/pMtqcbGHnv.json"></lottie-player>
      </div>
    </div>
    </div>
  )
